package day04ascidegerclassoperatormemeryusage;
...
public class WrapperClass {
   ...
   //  Wrapper class non primitive dir.O yuzden   memoryde cok yer kaplar.
     /*
        Primitive             Wrapper
        byte     ==>        Byte
        short    ==>        Short
...
//           ii)Wrapper Boolean'i primitive boolean'a ceviriniz.(Unboxing)
        ...
        char karakter='a';
        Character wkarakter=karakter;
        System.out.println(wkarakter);
...
//   Example 5 size  string olarak verilen iki fiyatin toplami ekrana yazdirin.
              String shirt ="5200";
              String shoes ="5200";
