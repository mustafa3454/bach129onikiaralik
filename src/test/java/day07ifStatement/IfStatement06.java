...
public class IfStatement06 {
    public static void main(String[] args) {
     ...
     Hata Mesaji olarak "Gecerli bir yas giriniz" yazdiriniz
        ...
        else if(age<5){System.out.println("Bebek");}
        else if (age<13){System.out.println("Cocuk");}
        else if (age<21){System.out.println("Genc");}
        else if (age<31){System.out.println("Yetiskin");}
        else {
